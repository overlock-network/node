...
func (*CompositionSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{0}
}
...
func (*CompositeTypeRef) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{1}
}
...
func (*Resource) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{2}
}
...
func (*Base) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{3}
}
...
func (*Patch) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{4}
}
...
func (*Transformer) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{5}
}
...
func (*MapTransform) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{6}
}
...
func (*StringTransform) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{7}
}
...
func (*StringConvert) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{8}
}
...
func (*StringFormat) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{9}
}
...
func (*MathTransform) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{10}
}
...
func (*MatchTransform) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{11}
}
...
func (*Pattern) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{12}
}
...
func (*ConvertTransform) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ae62832034fd5f2, []int{13}
}
...
func init() {
	proto.RegisterFile("overlock/overlock/composition_spec.proto", fileDescriptor_5ae62832034fd5f2)
}

var fileDescriptor_5ae62832034fd5f2 = []byte{
	// 828 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *CompositionSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
		...
		for iNdEx := len(m.Resources) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintCompositionSpec(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0x32
		}
	...
	if len(m.Mode) > 0 {
		i -= len(m.Mode)
		copy(dAtA[i:], m.Mode)
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.Mode)))
		i--
		dAtA[i] = 0x22
	}
...
func (m *CompositeTypeRef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Kind) > 0 {
		i -= len(m.Kind)
		copy(dAtA[i:], m.Kind)
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.Kind)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ApiVersion) > 0 {
		...
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.ApiVersion)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Resource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Base) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ForProvider) > 0 {
		for k := range m.ForProvider {
			...
			i -= len(v)
			copy(dAtA[i:], v)
			i = encodeVarintCompositionSpec(dAtA, i, uint64(len(v)))
			i--
			dAtA[i] = 0x12
			i -= len(k)
			copy(dAtA[i:], k)
			i = encodeVarintCompositionSpec(dAtA, i, uint64(len(k)))
			i--
			dAtA[i] = 0xa
			i = encodeVarintCompositionSpec(dAtA, i, uint64(baseI-i))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *Patch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ToFieldPath) > 0 {
		...
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.ToFieldPath)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.FromFieldPath) > 0 {
		...
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.FromFieldPath)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Type) > 0 {
		i -= len(m.Type)
		copy(dAtA[i:], m.Type)
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.Type)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *StringConvert) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Convert) > 0 {
		...
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.Convert)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *StringFormat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Fmt) > 0 {
		i -= len(m.Fmt)
		copy(dAtA[i:], m.Fmt)
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.Fmt)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MatchTransform) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FallbackValue) > 0 {
		...
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.FallbackValue)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.FallbackTo) > 0 {
		...
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.FallbackTo)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Patterns) > 0 {
...
func (m *Pattern) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Result) > 0 {
		...
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.Result)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Type) > 0 {
...
func (m *ConvertTransform) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Format) > 0 {
		...
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.Format)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ToType) > 0 {
		...
		i = encodeVarintCompositionSpec(dAtA, i, uint64(len(m.ToType)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintCompositionSpec(dAtA []byte, offset int, v uint64) int {
	offset -= sovCompositionSpec(v)
	base := offset
	for v >= 1<<7 {
...
func (m *CompositionSpec) Size() (n int) {
	...
	if m.CompositeTypeRef != nil {
		...
		n += 1 + l + sovCompositionSpec(uint64(l))
	}
	l = len(m.Mode)
	if l > 0 {
		n += 1 + l + sovCompositionSpec(uint64(l))
...
func (m *Base) Size() (n int) {
	...
	if len(m.ForProvider) > 0 {
		for k, v := range m.ForProvider {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovCompositionSpec(uint64(len(k))) + 1 + len(v) + sovCompositionSpec(uint64(len(v)))
			n += mapEntrySize + 1 + sovCompositionSpec(uint64(mapEntrySize))
		}
	}
	return n
}
...
func sovCompositionSpec(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozCompositionSpec(x uint64) (n int) {
	return sovCompositionSpec(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *CompositionSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowCompositionSpec
			}
			if iNdEx >= l {
		...
		case 3:
			...
			if msglen < 0 {
				return ErrInvalidLengthCompositionSpec
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipCompositionSpec(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipCompositionSpec(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowCompositionSpec
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthCompositionSpec
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupCompositionSpec
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthCompositionSpec        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowCompositionSpec          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupCompositionSpec = fmt.Errorf("proto: unexpected end of group")
)
