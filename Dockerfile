...
ENTRYPOINT ["/overlockd", "start", "--home", "/node", "--rpc.laddr", "tcp://0.0.0.0:26657", "--grpc.enable", "--grpc.address", "0.0.0.0:9090", "--api.enable", "--api.enabled-unsafe-cors", "--api.address", "tcp://0.0.0.0:1317", "--minimum-gas-prices", "0stake"]
