...
var (
	...
	fd_Provider_name        protoreflect.FieldDescriptor
	fd_Provider_url         protoreflect.FieldDescriptor
	fd_Provider_environment protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Provider_name = md_Provider.Fields().ByName("name")
	fd_Provider_url = md_Provider.Fields().ByName("url")
	fd_Provider_environment = md_Provider.Fields().ByName("environment")
...
func (x *fastReflection_Provider) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "overlock.crossplane.Provider.name":
		return x.Name != ""
	case "overlock.crossplane.Provider.url":
		return x.Url != ""
	case "overlock.crossplane.Provider.environment":
...
func (x *fastReflection_Provider) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "overlock.crossplane.Provider.name":
		panic(fmt.Errorf("field name of message overlock.crossplane.Provider is not mutable"))
	case "overlock.crossplane.Provider.url":
		panic(fmt.Errorf("field url of message overlock.crossplane.Provider is not mutable"))
	case "overlock.crossplane.Provider.environment":
		panic(fmt.Errorf("field environment of message overlock.crossplane.Provider is not mutable"))
	case "overlock.crossplane.Provider.id":
...
func (x *Provider) GetEnvironment() uint64 {
	if x != nil {
...
var file_overlock_crossplane_provider_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x73, 0x73, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x22, 0x62, 0x0a, 0x08, 0x50, 0x72, 0x6f,
	...
	0x72, 0x6f, 0x73, 0x73, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x42, 0x0d, 0x50, 0x72, 0x6f, 0x76, 0x69,
	0x64, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x20, 0x6f, 0x76, 0x65, 0x72,
...
var file_overlock_crossplane_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
