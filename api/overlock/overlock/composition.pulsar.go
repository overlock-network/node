...
var (
	...
	fd_Composition_apiVersion protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Composition_apiVersion = md_Composition.Fields().ByName("apiVersion")
...
func (x *fastReflection_Composition) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ApiVersion != "" {
		...
		if !f(fd_Composition_apiVersion, value) {
			return
		}
	}
	if x.Kind != "" {
...
func (x *fastReflection_Composition) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "overlock.overlock.Composition.apiVersion":
		return x.ApiVersion != ""
...
func (x *fastReflection_Composition) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "overlock.overlock.Composition.apiVersion":
		panic(fmt.Errorf("field apiVersion of message overlock.overlock.Composition is not mutable"))
	case "overlock.overlock.Composition.kind":
		panic(fmt.Errorf("field kind of message overlock.overlock.Composition is not mutable"))
	case "overlock.overlock.Composition.spec":
		panic(fmt.Errorf("field spec of message overlock.overlock.Composition is not mutable"))
	case "overlock.overlock.Composition.id":
...
func (x *Composition) GetSpec() string {
	if x != nil {
		return x.Spec
	}
	return ""
...
var file_overlock_overlock_composition_proto_rawDesc = []byte{
	...
	0x6f, 0x76, 0x65, 0x72, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0x65, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x70,
	0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1e, 0x0a, 0x0a, 0x61, 0x70, 0x69, 0x56, 0x65,
...
var file_overlock_overlock_composition_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
