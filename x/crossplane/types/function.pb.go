...
func (m *Function) GetEnvironment() uint64 {
	if m != nil {
...
var fileDescriptor_d039557c169db173 = []byte{
	...
	0x86, 0xa9, 0xd1, 0x43, 0xa8, 0x51, 0x4a, 0xe2, 0xe2, 0x70, 0x83, 0x2a, 0x13, 0x12, 0xe2, 0x62,
	...
	0xff, 0xff, 0xb4, 0xed, 0xda, 0x6c, 0xdc, 0x00, 0x00, 0x00,
}
...
func (m *Function) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Environment != 0 {
		i = encodeVarintFunction(dAtA, i, uint64(m.Environment))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Url) > 0 {
		i -= len(m.Url)
		copy(dAtA[i:], m.Url)
		i = encodeVarintFunction(dAtA, i, uint64(len(m.Url)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Name) > 0 {
...
func (m *Function) Size() (n int) {
	...
	if m.Environment != 0 {
		n += 1 + sovFunction(uint64(m.Environment))
	}
	if m.Id != 0 {
